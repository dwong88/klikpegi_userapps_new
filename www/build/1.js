...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_connectivity_service_connectivity_service__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_google_maps_google_maps__ = __webpack_require__(538);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__search_results_detail_search_results_detail__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_node_js_marker_clusterer__ = __webpack_require__(1111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_node_js_marker_clusterer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_node_js_marker_clusterer__);
...
var MapsPage = (function () {
    function MapsPage(platform, navParams, navCtrl, maps, loadingCtrl, currencyPipe, zone, popoverCtrl, translate) {
    ...
    MapsPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        var mapLoading;
        this.translate.get('LOADING_MAP').subscribe(function (value) { mapLoading = value; });
    ...
    MapsPage.prototype.addCluster = function (map) {
        var _this = this;
        var iconDefault = '../assets/images/pin.svg';
        var iconSelected = '../assets/images/pin-selected.svg';
        var activeMarker;
        var self = this;
        if (google.maps) {
            ...
            var markers = this.locations.map(function (location) {
                var label = String(_this.currencyPipe.transform(location.price, 'IDR', true));
            ...
            this.markerCluster = new __WEBPACK_IMPORTED_MODULE_6_node_js_marker_clusterer__(map, markers, {
    ...
    MapsPage.prototype.showDetail = function () {
        var data = this.propertyDetail;
        console.log(this.navParams.data);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__search_results_detail_search_results_detail__["a" /* SearchResultsDetailPage */], {
    ...
    MapsPage.prototype.presentPopover = function (myEvent) {
    ...
    MapsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-maps',template:/*ion-inline-start:"/Users/davidwong/Development/htdocs/klikpegi_userapp/src/pages/maps/maps.html"*/'<!--\n  Generated template for the MapsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header class="klikpegihead">\n  <ion-navbar>\n    <ion-title>\n      {{"MAP" | translate}}\n    </ion-title>\n    <ion-buttons right>\n      <button ion-button icon-only (click)="presentPopover($event)">\n        <ion-icon name="md-more"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  <div #pleaseConnect id="please-connect">\n    <p>Please connect to the Internet...</p>\n  </div>\n\n  <div #map id="map"></div>\n\n  <div *ngIf="showInfo" (click)="showDetail()">\n    <ion-row class="info-window">\n      <ion-col col-3>\n        <img style="object-fit:cover;height:100%" [src]="propertyDetail.thumbnail" />\n      </ion-col>\n      <ion-col>\n        <ion-row>\n          <ion-col class="text-title">\n            {{propertyDetail.name}}\n          </ion-col>\n        </ion-row>\n        <ion-row>\n          <ion-col class="text-content">\n            {{propertyDetail.addressRegion}}\n          </ion-col>\n        </ion-row>\n        <ion-row align-items-center>\n          <ion-col>\n            <rating [(ngModel)]="propertyDetail.rating" readOnly="true" max="5" emptyStarIconName="star-outline" halfStarIconName="star-half"\n              starIconName="star" nullable="false">\n            </rating>\n          </ion-col>\n        </ion-row>\n\n        <ion-row align-items-center>\n          <ion-col>\n            <ion-icon name="ios-pin-outline" item-start style="margin:0;color:rgb(105,105,105)"></ion-icon>\n            <span class="text-content"> {{propertyDetail.distance}} km </span>\n          </ion-col>\n        </ion-row>\n\n        <ion-row align-items-center>\n          <ion-col>\n            <span class="text-content"> {{currencySymbol}} {{propertyDetail.startFrom | number:\'1.0-0\'}}</span>\n          </ion-col>\n        </ion-row>\n\n        <!-- <span class="text-title">{{propertyDetail.name}}</span><br />\n        <span class="text-content">{{propertyDetail.addressRegion}}</span><br />\n        <span class="text-content">{{propertyDetail.distance}} km</span><br />\n        <span class="text-price">{{propertyDetail.startFrom | number:\'1.0-0\'}}</span> -->\n      </ion-col>\n    </ion-row>\n  </div>\n\n</ion-content>\n'/*ion-inline-end:"/Users/davidwong/Development/htdocs/klikpegi_userapp/src/pages/maps/maps.html"*/,
            providers: [__WEBPACK_IMPORTED_MODULE_3__providers_connectivity_service_connectivity_service__["a" /* ConnectivityServiceProvider */], __WEBPACK_IMPORTED_MODULE_1__angular_common__["c" /* CurrencyPipe */]]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__maps__ = __webpack_require__(1110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic2_rating__ = __webpack_require__(539);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MapsPageModule = (function () {
    ...
    MapsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__maps__["a" /* MapsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_3__maps__["a" /* MapsPage */]),
