...
export declare type LogFn = (message?: any, ...args: any[]) => void;
...
export declare type Validator = (input: string, key?: string) => boolean | string;
...
export declare type EmitEventFn = (eventName: string, options: {
    [key: string]: any;
}) => Promise<any>;
